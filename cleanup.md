...
## Required Steps
1. Identify the target interrupted issue from the provided context. If none is detected, stop and report: "No interrupted issue detected; cleanup pass is a no-op."
